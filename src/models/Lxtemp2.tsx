...
type GLTFResult = GLTF & {
    nodes: {
        ...
        Ext_hub_blackpaint_Submesh_41_Root_4004: THREE.Mesh
        Ext_hub_blackpaint_Submesh_41_Root_4004_1: THREE.Mesh
        Ext_hub_blackpaint_Submesh_41_Root_4004_2: THREE.Mesh
        Ext_blackpaint_Submesh_13718_Root_15002: THREE.Mesh
        Ext_brushedmetal_discbrake002_Submesh_890_Root_26002: THREE.Mesh
        Ext_tyres_Submesh_5734_Root_28002: THREE.Mesh
...
export default function Model({ ...props }: JSX.IntrinsicElements['group']) {
    ...
    const { nodes, materials } = useGLTF('/lxtemp2.glb') as GLTFResult
    ...
    return (
        ...
        <group ref={group} {...props} dispose={null} onDoubleClick={e => {e.stopPropagation(); clickHandler(e)}}>
            ...
            <group position={[0.63, 0.43, -1.45]} rotation={[Math.PI / 2, 0, Math.PI]} scale={0.01}>
                <mesh geometry={nodes.Ext_hub_blackpaint_Submesh_41_Root_4004.geometry} material={materials.black_plastic_matt} />
                <mesh geometry={nodes.Ext_hub_blackpaint_Submesh_41_Root_4004_1.geometry} material={materials['Meshpart12Mtl.001']} />
                <mesh geometry={nodes.Ext_hub_blackpaint_Submesh_41_Root_4004_2.geometry} material={materials['Meshpart12Mtl._ff']} />
            </group>
            ...
            <mesh geometry={nodes.Ext_tyres_Submesh_5734_Root_28002.geometry} material={materials['gum.001']} position={[-0.22, 0, -0.03]} rotation={[Math.PI / 2, 0, Math.PI]} scale={[-0.01, 0.01, 0.01]} />
