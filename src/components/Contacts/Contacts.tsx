                ...
                <div className={classes['Contacts__info']}>
                    ...
                    <div className={classes['Contacts__info-credentials']}>
                        ...
                        <div className={classes['Contacts__info-credentials-block']}>
                            ...
                            <p onClick={() => window.open('https://api.whatsapp.com/send?phone=79644444847&text=%D0%97%D0%B4%D1%80%D0%B0%D0%B2%D1%81%D1%82%D0%B2%D1%83%D0%B9%D1%82%D0%B5!%20', '_self')}><FaWhatsapp/></p>
                            <p onClick={() => window.open('https://t.me/SyndicateDetailing', '_self')}><FaTelegram/></p>
                        </div>
                        <div className={classes['Contacts__info-credentials-block']}>
